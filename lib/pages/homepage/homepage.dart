...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ParkingController parkingController = ParkingController();
    return Scaffold(
      appBar: AppBar(
                ...
                children: [
                  Expanded(
                    child: ParkingSlot(
                      ...
                      slotName: "A-1",
                      slotId: "1",
                      time: parkingController.slot1.value.parkingHours.toString(),
                    ),
                  ),
                  const SizedBox(
                    width: 60,
                  ...
                  Expanded(
                    child: ParkingSlot(
                      ...
                      slotName: "A-2",
                      slotId: "2",
                      time: parkingController.slot2.value.parkingHours.toString(),
                    ),
                  ),
                ],
              ),
